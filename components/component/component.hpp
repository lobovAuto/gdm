...
{
    ComponentBroadcastUnit(std::string address_call_file, 
                            std::string branch, std::string commit, bool is_force): 
...
class Component{
public:
    Component(std::string repo_address, std::string address_call_file, 
            std::string branch, std::string commit, bool is_force) : 
